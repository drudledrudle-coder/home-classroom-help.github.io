/**
 * The only server endpoint in the app. Backs the room sequencer with Netlify
 * Blobs.
 *
...
import type { RoomReq } from '../../shared/protocol'
import { handleRoomRequest } from '../../shared/roomHandler'
import type { RoomDoc, RoomStore, Stored } from '../../shared/roomHandler'
